...
namespace System
{
    ...
    public partial class Check
    {
        ...
        private const string DbcCheckAll = "DBC_CHECK_ALL";
        private const string DbcCheckInvariant = "DBC_CHECK_INVARIANT";
        private const string DbcCheckPostcondition = "DBC_CHECK_POSTCONDITION";
        private const string DbcCheckPrecondition = "DBC_CHECK_PRECONDITION";

        private const string PreconditionColon = "Precondition: ";
        private const string PostconditionColon = "Postcondition: ";
        private const string AssertionColon = "Assertion: ";
        private const string InvariantColon = "Invariant: ";

        private const string PreconditionFalied = "Precondition failed.";
        private const string PostconditionFalied = "Postcondition failed.";
        private const string AssertionFailed = "Assertion failed.";
        private const string InvariantFalied = "Invariant failed.";

        private const string NotNullFailingMessage = "{0} could not be null";
        private const string NotNullOrEmptyFailingMessage = "{0} could not be null or empty";
        private const string IsAssignableToFailingMessage = "{0} is not assignable to {1}";
        private const string GreaterThanFailingMessage = "{0} must be > {1}";
        private const string GreaterThanOrEqualFailingMessage = "{0} must be >= {1}";
        private const string LessThanFailingMessage = "{0} must be < {1}";
        private const string LessThanOrEqualFailingMessage = "{0} must be <= {1}";
        ...
        private sealed class NotNullCheckStrategy : ICheckStrategy
        {
            ...
            {
                return string.Format(NotNullFailingMessage, objName);
            }
        ...
        private sealed class NotNullOrEmptyStrategy : ICheckStrategy
        {
            ...
            public string GetFailingMessage(string objName)
            {
                return string.Format(NotNullOrEmptyFailingMessage, objName);
            }
        ...
        private sealed class IsAssignableToStrategy<TArgetType> : ICheckStrategy
        {
            ...
            public string GetFailingMessage(string objName)
            {
                return string.Format(IsAssignableToFailingMessage, objName, typeof(TArgetType));
            }
        ...
        private sealed class GreaterThanStrategy<T> : ICheckStrategy
        {
            ...
            public bool Pass(object obj)
            {
                if (obj is T && ((IComparable)obj).CompareTo(_compareValue) > 0)
                    return true;
            ...
            public string GetFailingMessage(string objName)
            {
                return string.Format(GreaterThanFailingMessage, objName, _compareValue);
            }
        ...
        private sealed class GreaterThanOrEqualStrategy<T> : ICheckStrategy
        {
            ...
            public string GetFailingMessage(string objName)
            {
                return string.Format(GreaterThanOrEqualFailingMessage, objName, _compareValue);
            }
        ...
        private sealed class LessThanStrategy<T> : ICheckStrategy
        {
            ...
            public string GetFailingMessage(string objName)
            {
                return string.Format(LessThanFailingMessage, objName, _compareValue);
            }
        ...
        private sealed class LessThanOrEqualStrategy<T> : ICheckStrategy
        {
            ...
            public string GetFailingMessage(string objName)
            {
                return string.Format(LessThanOrEqualFailingMessage, objName, _compareValue);
            }

            #endregion ICheckStrategy Members
        }

        #endregion Predefined Check Strategies

        #endregion Pluginable Check Strategies
        ...
        [Conditional(DbcCheckInvariant)]
        [Conditional(DbcCheckPostcondition)]
        [Conditional(DbcCheckPrecondition)]
        ...
        public static void Require(bool assertion)
        {
            if (UseExceptions)
            {
                if (!assertion) throw new PreconditionException(PreconditionFalied);
            }
            else
            {
#if USE_TRACE_ASSERTION
        ...
        public static void Ensure(bool assertion)
        {
            if (UseExceptions)
            {
                if (!assertion) throw new PostconditionException(PostconditionFalied);
            }
            else
            {
#if USE_TRACE_ASSERTION
        ...
        public static void Invariant(bool assertion)
        {
            if (UseExceptions)
            {
                if (!assertion) throw new InvariantException(InvariantFalied);
            }
            else
            {
#if USE_TRACE_ASSERTION
        ...
        public static void Assert(bool assertion)
        {
            if (UseExceptions)
            {
                if (!assertion) throw new AssertionException(AssertionFailed);
            }
            else
            {
#if USE_TRACE_ASSERTION
        ...
        #endregion Use Exception Or Trace/Debug Assertion?
    } // End Check
