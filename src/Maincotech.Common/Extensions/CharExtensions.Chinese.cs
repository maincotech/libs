...
namespace System
{
    public static class CharExtensions
    {
        ...
        private static readonly Encoding _gb2312Encoding = Encoding.GetEncoding("GB2312");

        public static string GetPinYin(this char chineseChar)
        {
            if (_regexForChineseChar.IsMatch(chineseChar.ToString()))
            {
                var arr = _gb2312Encoding.GetBytes(chineseChar.ToString());
                ...
                var pos = Array.IndexOf(_otherChinese, chineseChar.ToString());
        ...
        // 匹配中文字符
        private static readonly Regex _regexForChineseChar = new Regex("^[\u4e00-\u9fa5]$");
